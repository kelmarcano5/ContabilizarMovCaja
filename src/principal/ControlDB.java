...
public class ControlDB extends ConexionDB{
	...
	public ResultSet consultarMovCajas()
	{
    	String sql;
    	ResultSet rs=null;
    	Statement stmt;
		...
		try {
			sql="SELECT "
					  + "smn_caja.smn_mov_caja_cabecera.mcc_fecha_registro, "
					  + "smn_caja.smn_mov_caja_cabecera.smn_documento_id, "
					  + "smn_caja.smn_caja.smn_entidad_rf, "
					  + "smn_caja.smn_caja.smn_sucursal_rf, "
					  ...
					  + "case when smn_caja.smn_mov_caja_cabecera.smn_moneda_rf is null then 0 else smn_caja.smn_mov_caja_cabecera.smn_moneda_rf end, "
					  + "Sum(smn_caja.smn_mov_caja_cabecera.mcc_monto_ml_documento) AS total_monto_mov_caja_ml, "
					  + "Sum(smn_caja.smn_mov_caja_cabecera.mcc_monto_ma_documento) AS total_monto_mov_caja_ma, "
					  + "smn_caja.smn_documento.doc_descripcion "
					  + "FROM "
					  ...
					  + "INNER JOIN smn_caja.smn_documento ON smn_caja.smn_mov_caja_cabecera.smn_documento_id = smn_caja.smn_documento.smn_documento_id "
					  + "INNER JOIN smn_cont_financiera.smn_rel_modulo_documento_tipo_doc ON smn_caja.smn_documento.smn_doc_gen_contable = smn_cont_financiera.smn_rel_modulo_documento_tipo_doc.smn_documentos_generales_rf "
					  + "INNER JOIN smn_cont_financiera.smn_tipo_documento ON smn_cont_financiera.smn_rel_modulo_documento_tipo_doc.smn_tipo_documento_id = smn_cont_financiera.smn_tipo_documento.smn_tipo_documento_id "
					  + "INNER JOIN smn_base.smn_auxiliar ON smn_caja.smn_caja.smn_auxiliar_rf = smn_base.smn_auxiliar.smn_auxiliar_id "
					  + "WHERE "
					  + "smn_caja.smn_mov_caja_cabecera.mcc_fecha_registro <current_date  "
					  + "and "
					  + "smn_caja.smn_mov_caja_cabecera.mcc_estatus_registro = 'GE' "
					  + "and "
					  + "smn_cont_financiera.smn_rel_modulo_documento_tipo_doc.smn_modulos_rf = 19 "
					  + "GROUP BY "
					  + "smn_caja.smn_mov_caja_cabecera.mcc_fecha_registro, "
					  + "smn_caja.smn_mov_caja_cabecera.smn_documento_id, "
					  + "smn_caja.smn_caja.smn_entidad_rf, "
					  ...
					  + "smn_cont_financiera.smn_rel_modulo_documento_tipo_doc.smn_documentos_generales_rf, "
					  + "smn_cont_financiera.smn_rel_modulo_documento_tipo_doc.smn_tipo_documento_id, "
					  + "smn_caja.smn_mov_caja_cabecera.smn_moneda_rf, "
					  + "smn_caja.smn_documento.doc_descripcion "
					  + "ORDER BY "
					  + "smn_caja.smn_mov_caja_cabecera.mcc_fecha_registro ASC ";
	...
	public void updateMovCajaCabecera(int smn_entidad_rf, int smn_sucursal_rf, int smn_documento_id, int smn_moneda_rf, Date mcc_fecha_registro, int smn_control_cierre_contable_id)
	{
    	String sql;
    	PreparedStatement stmt;
    	
		try {	
			sql="UPDATE smn_caja.smn_mov_caja_cabecera SET  "
			  + "smn_control_cierre_contable_id=? "
			  + "FROM  smn_caja.smn_caja "		
			  + "WHERE "
			  + "smn_caja.smn_mov_caja_cabecera.smn_caja_id = smn_caja.smn_caja.smn_caja_id "
			  + "AND "
			  + "smn_caja.smn_caja.smn_entidad_rf=? "
			  + "AND "
			  + "smn_caja.smn_caja.smn_sucursal_rf=? "
			...
			stmt.setDate(6, mcc_fecha_registro);
			stmt.executeUpdate();
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	public ResultSet moduloMovCaja()
	{
    	String sql;
    	ResultSet rs=null;
    	Statement stmt;
	...
	public ResultSet consultarDetalles(int smn_entidad_rf, int smn_sucursal_rf, int smn_documento_id, int smn_moneda_rf, Date fca_fecha_registro)
	{
		...
		try {
			sql="SELECT "
					  ...
					  + "Sum(smn_caja.smn_dist_pago_detalle.dpd_monto_del_pago_ml) AS total_monto_detalle_mov_caja_ml, "
					  + "Max(smn_caja.smn_dist_pago_detalle.dpd_monto_del_pago_ma) AS total_monto_detalle_mov_caja_ma "
					  + "FROM "
					  + "smn_caja.smn_mov_caja_cabecera "
					  + "INNER JOIN smn_caja.smn_caja ON smn_caja.smn_mov_caja_cabecera.smn_caja_id = smn_caja.smn_caja.smn_caja_id "
					  + "INNER JOIN smn_caja.smn_dist_pago_detalle ON smn_caja.smn_mov_caja_cabecera.smn_mov_caja_cabecera_id = smn_caja.smn_dist_pago_detalle.smn_mov_caja_cabecera_id "
					  + "INNER JOIN smn_base.smn_formas_pago ON smn_caja.smn_dist_pago_detalle.smn_forma_pago_rf = smn_base.smn_formas_pago.smn_formas_pago_id "
					  + "WHERE "
					  + "smn_caja.smn_mov_caja_cabecera.mcc_fecha_registro ='"+fca_fecha_registro+"'"
					  + "and "
					  + "smn_caja.smn_mov_caja_cabecera.mcc_estatus_registro = 'GE' "
					  + "AND "
	...
	public ResultSet consultarDiccionario()
	{
		...
		try {
			...
			sql="SELECT smn_diccionario_id "
			  ...
			  + "WHERE "
			  + "dic_esquema='smn_caja' "
			  + "AND "
			  + "(dic_tabla='smn_dist_pago_detalle') ";
			  //+ "AND "
			  //+ "dic_campo='"+campo+"'";
	...
	public ResultSet consultarComponente(int smn_forma_pago_rf)
	{
    	String sql;
    	ResultSet rs=null;
    	Statement stmt;
		...
		try {
			sql="SELECT "
			  ...
			  + "WHERE "
			  + "smn_componentes_id="+smn_forma_pago_rf;
	...
	public void updateMovCaja(String fca_estatus_proceso, int smn_entidad_rf, int smn_sucursal_rf,
			int smn_documento_id, int smn_moneda_rf, Date mcc_fecha_registro)
	{
		String sql;
		PreparedStatement stmt;		
